...
$onboardMap = [ordered]@{
  ...
  'Your All-in-One Work App' = 'Seu app de trabalho completo'
  'See booking details, update status, and chat with ease. eMart Worker -Available in multiple languages.' = 'Veja detalhes das reservas, atualize o status e converse com facilidade. Arrow Worker — disponível em vários idiomas.'
  ...
  'Welcome to eMart!' = 'Bem-vindo à Arrow!'
  ...
  'Welcome to eMart Worker!' = 'Bem-vindo ao Arrow Worker!'
  ...
  'Welcome to eMart-Provider!' = 'Bem-vindo ao Arrow Prestador!'
  ...
  'Work Simplified Globally' = 'Trabalho simplificado'
  'Manage bookings, chat in multiple languages, and get things done efficiently with eMart Worker.' = 'Gerencie reservas, converse em vários idiomas e resolva tudo com eficiência no Arrow Worker.'
