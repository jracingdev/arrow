const Map<String, String> enUS = {
  ...
  'Send Code': 'Send Code',
  'Email address': 'Email address',
  'Please enter a valid 10-digit mobile number': 'Please enter a valid Brazilian phone number (10 or 11 digits with area code)',
  ...
  'Verify': 'Verify',
  'OTP sent': 'OTP sent',
  'We sent the code as a notification on this device. It is not an SMS.': 'We sent the code as a notification on this device. It is not an SMS.',
  ...
  'Compartilhar localização': 'Share location',
  'Não há localização para compartilhar.': 'There is no location to share.',
  'Não foi possível compartilhar a localização.': 'Could not share the location.',
  'Prestador iniciou antes do horário': 'The provider started before the scheduled time',
  'Prestador não compareceu': 'Provider did not show up',
  'Abuso': 'Abuse',
  'Assédio': 'Harassment',
  'Péssimo atendimento': 'Poor service',
  'Levou o dinheiro e não fez o serviço': 'Took the money and did not do the job',
  'Outro': 'Other',
  'A plataforma vai analisar sua denúncia.': 'The platform will review your report.',
  'Denúncias verificadas e reincidentes podem levar à suspensão da conta.': 'Verified and repeat complaints can lead to account suspension.',
  'Descreva o que aconteceu': 'Describe what happened',
  'Enviar denúncia': 'Submit report',
  'Enviando...': 'Sending...',
  'Abrir no mapa': 'Open in maps',
  'Local do serviço': 'Service location',
  'Prestador a caminho': 'Provider on the way',
  'Este prestador está indisponível.': 'This provider is unavailable.',
  ...
  'Share app': 'Share app',
  'Check out Arrow, the ultimate all-in-one multi-vendor platform.': 'Check out Arrow, the ultimate all-in-one multi-vendor platform.',
  ...
  'Invite your friends to sign up with Arrow using your code, and you’ll earn': 'Invite your friends to sign up with Arrow using your code, and you’ll earn',
  ...
  'Pedir prestador próximo': 'Request nearby provider',
  'Como um chamado: prestadores perto de você veem o pedido e o primeiro que aceitar fica com ele.': 'Like hailing a ride: nearby providers see the request and the first to accept gets the job.',
  'Mais próximos primeiro': 'Closest first',
  'Pedir agora (próximos)': 'Request now (nearby)',
  'Pedir agora': 'Request now',
  'Agendar': 'Schedule',
  'Escolher profissional': 'Choose a professional',
  'Prestadores disponíveis perto de você. O primeiro que aceitar fica com o pedido.': 'Available providers near you. The first to accept gets the job.',
  'Lista por distância, nota e documentação verificada.': 'Sorted by distance, rating and verified documents.',
  'Só verificados': 'Verified only',
  'Ordenado por distância, depois nota. Profissionais verificados primeiro.': 'Sorted by distance, then rating. Verified professionals first.',
  'Profissional verificado': 'Verified professional',
  'avaliações': 'reviews',
  'Proteção Arrow': 'Arrow protection',
  'Documentação verificada pela plataforma. Em caso de problema, use denúncia no pedido.': 'Documents verified by the platform. If something goes wrong, report it on the order.',
  'Procurando prestador próximo…': 'Looking for a nearby provider…',
  'Estamos avisando prestadores próximos. O primeiro que aceitar fica com o pedido.': 'We are notifying nearby providers. The first to accept gets the job.',
  'Avisamos o prestador mais próximo. Se ele não responder, chamamos o seguinte.': 'We are pinging the closest provider. If they do not answer, we call the next one.',
  'Nenhum prestador disponível': 'No provider available',
  'Ninguém aceitou seu pedido em 10 minutos.': 'Nobody accepted your request within 10 minutes.',
  'Tempo restante': 'Time left',
  'Voltar': 'Back',
  'Cancelar busca': 'Cancel search',
  'Prestador encontrado': 'Provider found',
  'Outro prestador já aceitou': 'Another provider already accepted',
  'Pedido cancelado': 'Order cancelled',
  'Procurando…': 'Searching…',
  'O preço é definido pelo prestador que aceitar. Para preço fixo, você paga depois da aceitação.': 'Price is set by the provider who accepts. For fixed-price jobs, you pay after acceptance.',
};
