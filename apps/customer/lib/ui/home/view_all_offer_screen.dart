                ...
                children: <TextSpan>[
                  ...
                  TextSpan(
                    text: " & get".tr() +
                        ...
                        "${offerModel.discountTypeOffer == "Fix Price" ? (currencyData!.symbolatright == true) ? "${offerModel.discountOffer}${currencyData!.symbol.toString()} OFF" : "${currencyData!.symbol.toString()}${offerModel.discountOffer} OFF" : "${offerModel.discountOffer} % Off"}",
                    style: const TextStyle(
                        fontSize: 16.0,
                        color: Colors.grey,
                        fontWeight: FontWeight.w700),
