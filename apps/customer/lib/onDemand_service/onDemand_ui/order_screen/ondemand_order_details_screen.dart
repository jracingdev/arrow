...
class OnDemandOrderDetailsScreen extends StatefulWidget {
  ...
  @override
  _OnDemandOrderDetailsScreenState createState() =>
      _OnDemandOrderDetailsScreenState();
}

class _OnDemandOrderDetailsScreenState
    extends State<OnDemandOrderDetailsScreen> {
  ...
  getData() async {
    ...
    providerUser =
        await FireStoreUtils.getUserProfile(onProviderOrder!.authorID);
    setState(() {});
    await getDetails();
  }
  ...
  getDetails() {
    coupon = FireStoreUtils().getProviderCouponAfterExpire(
        onProviderOrder!.provider.author.toString());
    coupon.then((value) {
      if (value.isNotEmpty) {
        couponList = value;
        setState(() {});
      ...
      body: onProviderOrder != null
          ? StreamBuilder(
              ...
              builder: (context, snapshot) {
                ...
                OnProviderOrderModel onProviderOrder =
                    OnProviderOrderModel.fromJson(snapshot.data!.data()!);
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            (onProviderOrder.status == ORDER_STATUS_ACCEPTED ||
                                    ...
                                    (onProviderOrder.workerId != null &&
                                        onProviderOrder.workerId!.isNotEmpty)
                                ? Padding(
                                    padding: EdgeInsets.only(top: 6),
                                    child: Column(
                                      crossAxisAlignment:
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              ...
                                                                              style: TextStyle(color: isDarkMode(context) ? Colors.white : Colors.black, fontFamily: AppThemeData.regular, fontSize: 14, fontWeight: FontWeight.bold),
                                                                            ),
                                                                            Container(
                                                                              ...
                                                                              child: Padding(
                                                                                ...
                                                                                child: Row(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Text(
                                                                                      model.reviewsCount != 0 ? ((model.reviewsSum ?? 0.0) / (model.reviewsCount ?? 0.0)).toStringAsFixed(1) : 0.toString(),
                                                                                      style: const TextStyle(
                                                                                        letterSpacing: 0.5,
                                                                                        fontSize: 12,
                                                                                        fontFamily: AppThemeData.regular,
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            Visibility(
                                              visible: onProviderOrder.status ==
                                                      ORDER_STATUS_COMPLETED
                                                  ? true
                                                  : false,
                                              child: Padding(
                                                          ...
                                                          children: [
                                                            ...
                                                            if ((isSubscriptionModelApplied ==
                                                                ...
                                                                ((isSubscriptionModelApplied ==
                                                                            true ||
                                                                        sectionConstantModel?.adminCommision?.enable ==
                                                                            true) &&
                                                                    onProviderOrder
                                                                            .provider
                                                                            .subscriptionPlan
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    push(
                                                                        ...
                                                                        ChatScreens(
                                                                          isChatEnable:
                                                                              ((isSubscriptionModelApplied == true || sectionConstantModel?.adminCommision?.enable == true) && onProviderOrder.provider.subscriptionPlan?.features?.chat == true),
                                                                          type:
                                                                              "provider_chat",
                                            ...
                                            finalTotalAmount = totalAmount +
                                                double.parse(onProviderOrder
                                                    ...
                                                    ? onProviderOrder
                                                        ...
                                                        .toString()
                                                    : "0.0");
                                            onProviderOrder.discount =
                                                discountAmount.toString();
                                            onProviderOrder.discountType =
                                                discountType.toString();
                                            onProviderOrder.discountLabel =
                                                discountLable.toString();
                                            onProviderOrder.couponCode =
                                                offerCode.toString();
  ...
  Widget priceTotalRow() {
    ...
    if (onProviderOrder!.provider.disPrice == "" ||
      ...
      price = double.parse(onProviderOrder!.provider.price ?? '0') *
          onProviderOrder!.quantity;
    } else {
      price = double.parse(onProviderOrder!.provider.disPrice ?? '0') *
          onProviderOrder!.quantity;
    }
                    ...
                    children: [
                      Text(
                        onProviderOrder!.provider.disPrice == "" ||
                                onProviderOrder!.provider.disPrice == "0"
                            ? "${amountShow(amount: '${onProviderOrder!.provider.price}')} × ${onProviderOrder!.quantity.toStringAsFixed(2)}"
                            : "${amountShow(amount: '${onProviderOrder!.provider.disPrice}')} × ${onProviderOrder!.quantity.toStringAsFixed(2)}",
                        style: TextStyle(
                          color:
    ...
    return AlertDialog(
      ...
      content: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: TextStyle(
              color:
                  isDarkMode(context) ? Colors.white : const Color(0Xff333333),
              fontFamily: AppThemeData.regular,
              fontWeight: FontWeight.w500,
            ),
            ...
            if (cancelBookingController.text.toString() == "") {
              ...
              if (onProviderOrder.provider.priceUnit == "Fixed") {
                ...
                if (onProviderOrder.provider.disPrice == "" ||
                  ...
                  total += onProviderOrder.quantity *
                      double.parse(
                          onProviderOrder.provider.disPrice.toString());
                }
                double adminComm =
                    sectionConstantModel?.adminCommision?.enable == false
                        ? 0.0
                        : (onProviderOrder.adminCommissionType!.toLowerCase() ==
                            ...
                            ? (total *
                                    double.parse(
                                        onProviderOrder.adminCommission!)) /
                                100
                ...
                if (onProviderOrder.payment_method.toLowerCase() != 'cod') {
                  ...
                  await FireStoreUtils.firestore
                      ...
                      .set(wallet.toJson())
                      .then((value) async {
                    await FireStoreUtils.updateOtherWalletAmount(
                        userId: onProviderOrder.author.userID,
                        amount: total.toDouble());
                  });
                  ...
                  if (onProviderOrder.status == ORDER_STATUS_ACCEPTED) {
                    ...
                    await FireStoreUtils.updateOtherWalletAmount(
                        amount: -total,
                        userId: onProviderOrder.provider.author.toString());
                  }
                }

                if (onProviderOrder.status == ORDER_STATUS_ACCEPTED &&
                    onProviderOrder.adminCommission != '0') {
              ...
              log("onProviderOrder :: ${onProviderOrder.status} :: ${isSubscriptionModelApplied} :: ${sectionConstantModel?.adminCommision?.enable} ");
              if (onProviderOrder.status == ORDER_STATUS_ACCEPTED &&
                  (isSubscriptionModelApplied == true ||
                      sectionConstantModel?.adminCommision?.enable == true)) {
                User? providerUser = await FireStoreUtils.getProviderUser(
                    onProviderOrder.provider.author!);
                log("onProviderOrder :::: ${providerUser?.userID} ");
                if (providerUser?.subscriptionPlanId != null) {
                  if (providerUser?.subscriptionTotalOrders != '-1' &&
                      providerUser?.subscriptionTotalOrders != null) {
                    String subscriptionTotalOrders =
                        (int.parse(providerUser!.subscriptionTotalOrders!) + 1)
                            .toString();
                    await FireStoreUtils.getProviderServices(
                      ...
                      for (var element in value) {
                        ...
                        await FireStoreUtils.updateProvider(element);
                      }
                    });
                    providerUser.subscriptionTotalOrders =
                        subscriptionTotalOrders;
                    await FireStoreUtils.updateProviderUser(providerUser);
                  }
                }
              }
              ...
              if (providerUser != null) {
                ...
                await SendNotification.sendFcmMessage(providerBookingCancel,
                            ...
                            onPressed: () {
                              setState(() {
                                for (int a = 0;
                                  ...
                                  print(
                                      "=====>${couponTextFieldController.text.toString()}");
                                  print(
                                  ...
                                  if (couponTextFieldController.text
                                      ...
                                      couponModel.offerCode!
                                          .toLowerCase()
                                          .toString()) {
                                    discountType = couponModel.discountTypeOffer
                                        .toString();
                                    discountLable =
