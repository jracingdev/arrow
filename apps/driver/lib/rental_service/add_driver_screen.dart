...
class _AddDriverScreenState extends State<AddDriverScreen> {
  ...
  buildTextFormField(
      {required String title, TextInputType textInputType = TextInputType.text, validator, isEnable = true, readOnly = false, required TextEditingController controller}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
                ...
                User user = User(
                    ...
                    geoFireData: GeoFireData(
                        geohash: Geoflutterfire()
                            .point(latitude: widget.driverDetails!.location.latitude.toDouble(), longitude: widget.driverDetails!.location.longitude.toDouble())
                            .hash,
