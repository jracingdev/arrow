...
class _ChatScreensState extends State<ChatScreens> {
  ...
  getVenderData() async {
    ...
    isActiveChat = ((isSubscriptionModelApplied == false &&
            vendorModel.adminCommission?.enable == false) ||
        ((isSubscriptionModelApplied ||
                vendorModel.adminCommission?.enable == true) &&
            vendorModel.subscriptionPlan?.features?.chat == true));
    setState(() {});
  }
                          ...
                          onPressed: () async {
                            if (isActiveChat == false) {
                              ShowToastDialog.showToast(
                                  "Chat feature is off due to subscription limits."
                                      .tr());
                            } else {
                              _onCameraClick();
                            }
