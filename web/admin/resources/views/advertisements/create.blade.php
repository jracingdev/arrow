    ...
    <script>
        ...
        function setDate(startDate = null, endDate = null) {
            if (!startDate || !endDate) {
                ...
                $('#daterange span').html(moment(startDate).format('DD-MM-YYYY') + ' - ' + moment(endDate).format(
                    'DD-MM-YYYY'));
            }
            ...
            $('#daterange').on('apply.daterangepicker', function(ev, picker) {
                $('#daterange span').html(picker.startDate.format('DD-MM-YYYY') + ' - ' + picker.endDate.format(
                    'DD-MM-YYYY'));
            });
