...
<script>
    ...
    $(".user_cpf").on("input", function() {
        var digits = $(this).val().replace(/\D/g, '').slice(0, 11);
        var parts = [digits.slice(0, 3), digits.slice(3, 6), digits.slice(6, 9), digits.slice(9, 11)].filter(Boolean);
